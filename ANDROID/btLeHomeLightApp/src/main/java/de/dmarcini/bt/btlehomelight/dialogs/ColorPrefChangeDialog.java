...
public class ColorPrefChangeDialog extends DialogFragment implements ColorPicker.OnColorChangedListener, ColorPicker.OnColorSelectedListener, View.OnClickListener
{
  ...
  private final short[] rgbw = new short[ 4 ];
  private IBtCommand   runningActivity;
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState)
  {
    ...
    try
    {
      ...
      predefColor = arg.getInt(PredefColorsFragment.ARG_CURRENT_COLOR, 0xff606060);
      predefColorNumber = arg.getInt(PredefColorsFragment.ARG_PREDEF_NR, -1);
    ...
    //
    if( getActivity() instanceof IBtCommand )
    {
      runningActivity = ( IBtCommand ) getActivity();
    }
    else
    {
      Log.e(TAG, "Application is not type of IBtCommand");
  ...
  public void onColorChanged(int color)
  {
    ...
    rgbw[ 3 ] = 0;
    //
    if( timeToSend < System.currentTimeMillis() && runningActivity != null )
    {
